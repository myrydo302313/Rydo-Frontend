...
const VehiclePanel = ({setShowVehiclePanel,setShowConfirmPanel}) => {
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Rydo Cab <span><i className="ri-user-3-fill"></i></span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Rydo Moto <span><i className="ri-user-3-fill"></i></span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Rydo Auto <span><i className="ri-user-3-fill"></i></span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
